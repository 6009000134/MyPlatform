...
namespace MyPlatform.SQLServerDAL  
{
		...
		public partial class Sys_Columns: ISys_Columns
	{
		...
		public bool Exists()
		{
			...
			strSql.Append("select count(1) from Sys_Columns");
			strSql.Append(" where ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Sys_Columns(");			
            strSql.Append("ID,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,Deleted,TableID,TableName,ColumnName,ColumnName_EN,ColumnName_CN,ColumnType,Size,Remark");
			...
			SqlParameter[] parameters = {
                        ...
                        new SqlParameter("@ColumnName_EN", SqlDbType.VarChar,50) ,            
                        new SqlParameter("@ColumnName_CN", SqlDbType.NVarChar,30) ,            
            ...
            parameters[8].Value = model.ColumnName;                        
            parameters[9].Value = model.ColumnName_EN;                        
            parameters[10].Value = model.ColumnName_CN;                        
            parameters[11].Value = model.ColumnType;                        
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_Columns set ");
            ...
            strSql.Append(" ColumnName_EN = @ColumnName_EN , ");                                    
            strSql.Append(" ColumnName_CN = @ColumnName_CN , ");                                    
...
SqlParameter[] parameters = {
		...
		public bool Delete()
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_Columns ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};
		...
		public MyPlatform.Model.Sys_Columns GetModel()
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID, CreatedBy, CreatedDate, UpdatedBy, UpdatedDate, Deleted, TableID, TableName, ColumnName, ColumnName_EN, ColumnName_CN, ColumnType, Size, Remark  ");			
			strSql.Append("  from Sys_Columns ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};

			
			MyPlatform.Model.Sys_Columns model=new MyPlatform.Model.Sys_Columns();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
																																...
																																if(ds.Tables[0].Rows[0]["TableID"].ToString()!="")
				{
					model.TableID=int.Parse(ds.Tables[0].Rows[0]["TableID"].ToString());
																																...
																																model.ColumnName_EN= ds.Tables[0].Rows[0]["ColumnName_EN"].ToString();
																																model.ColumnName_CN= ds.Tables[0].Rows[0]["ColumnName_CN"].ToString();
																																model.ColumnType= ds.Tables[0].Rows[0]["ColumnType"].ToString();
